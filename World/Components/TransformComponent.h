...
struct TransformComponent {
	...
	TransformComponent() : TransformMatrix(1.0f), translation(0.0f), size(1.0f), rotation(glm::angleAxis(glm::degrees(0.0f), glm::vec3(0.0f, 1.0f, 0.0f))) {}
	...
	TransformComponent(const glm::vec3& translation, const glm::vec3& scale = glm::vec3(1.0f),
		...
		rotation(glm::angleAxis(glm::degrees(rotation_angle), glm::vec3(rotation_axis) ))
	{
