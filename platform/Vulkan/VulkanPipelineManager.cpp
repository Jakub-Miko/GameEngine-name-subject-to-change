...
VulkanPipeline::VulkanPipeline(const PipelineDescriptor& desc)
{
}

VulkanPipeline::VulkanPipeline(PipelineDescriptor&& desc)
{
}
...
std::shared_ptr<Pipeline> VulkanPipelineManager::CreatePipeline(const PipelineDescriptor& desc)
{
	...
	info.layout = ; // generate from root signature
