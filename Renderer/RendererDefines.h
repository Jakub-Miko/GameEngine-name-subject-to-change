...
enum class RenderState : unsigned char
{
	...
	TEXTURE_DEPTH_SAMPLE = 13, TEXTURE_PRESENT = 14
};
...
enum class TextureFormat : unsigned char {
	...
	R_UNSIGNED_CHAR = 6, R_8FLOAT = 7, R_UNSIGNED_CHAR_NORM = 8, DEFAULT_DEPTH = 9, DEFAULT_DEPTH_STENCIL = 10, BGRA_SRGB = 11, RG_32FLOAT = 12,RG_16FLOAT = 13, RG_CHAR_NORM = 14 ,RGBA_16FLOAT = 15, UNDEFINED = 16
};
